...
namespace App\Connections\Banks\Nubank;

class Nubank {

    const CLIENT_AGENT = "NuApi";
     ...
     */
    public function __construct($refreshToken = false, $certPath = false, $sessionInfo = null) {
    ...
    public function solicitarCodigoPorEmail($cpf, $senhaApp, $idDeviceIdAleatorio, $openssl_conf_location) {
        ...
        $this->authenticator = new Authenticator($cpf, $senhaApp, $idDeviceIdAleatorio, $openssl_conf_location);
     ...
     */
    public function confirmarCodigoEmail($encryptedCode, $codigo, $destino_certificado, $cpf, $senhaApp, $idDeviceIdAleatorio, $openssl_conf_location) {
    ...
    private function carregarInfoSessao() {
        ...
        $sessionInfo = json_decode($this->sessionInfo);
    ...
    private function salvarInfoSessao($json) {
        ...
        $this->sessionInfo = json_encode($sessionInfo);
    }
    ...
    public function autenticarComTokenECertificado() {
        ...
        if ($sessionInfo) {
            ...
            $result = Curl::postUsingCert(self::URL_TOKEN, $payload, $this->certPath);
    ...
    public function getEvents() {
        ...
        $result = Curl::getUsingCertAndToken($this->eventsURL, $this->certPath, $this->sessionAccessToken);
